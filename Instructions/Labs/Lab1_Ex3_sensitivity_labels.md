...
## 任务 6 - 为高度机密内容创建和发布 DKE 标签

在此任务中，你将在内置高度机密标签下创建子标签。 此子标签将使用双重密钥加密 (DKE) 和动态水印来保护仅由法务访问的敏感内容。 你还将配置一个标签策略，该策略需要降级标签的理由。
...
1. 在“**敏感度标签**”页上，找到“**高度机密**”的敏感度标签。 选择垂直省略号 (**...**)，然后从下拉列表中选择“**+ 创建子标签**”。
